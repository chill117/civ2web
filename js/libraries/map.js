...
(function () {
	...
	app.Map = function(tiles) {
		...
		*/
		...
		// "Public" methods.
		this.get_neighboring_open_ocean_tiles 	= get_neighboring_open_ocean_tiles;
		this.get_neighboring_ocean_tiles 		= get_neighboring_ocean_tiles;
		this.get_neighboring_coordinates 		= get_neighboring_coordinates;
		this.calculate_tile_position 			= calculate_tile_position;
		this.is_land_tile 						= is_land_tile;
		this.is_ocean_tile 						= is_ocean_tile;
		this.get_tile 							= get_tile;
		this.coordinates_are_valid 				= coordinates_are_valid;
		this.set_tile_type 						= set_tile_type;
		this.set_tile_resource 					= set_tile_resource;
		this.get_all_tiles 						= get_all_tiles;
